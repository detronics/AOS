...
class Tasks(tk.Frame):
    ...
    def init_tasks(self):
        ...
        self.description_list = ['Возьмите под охрану ШС№ 15, прибора № 2',
                                 'Снимите с охраны все ШС прибора № 10',
                                 'Выполните сброс тревог с прибора № 11', 'Выполните запуск АСПТ № 4',
                                 ...
                                 'Установите время на приборе 12:00:00',
                                 'Установите дату  на приборе 11:08:99',
                                 'Включите тест извещателя с адресом 4 прибора № 5',
                                 'Измените пароль № 2 на "4321"', ' Измените адрес пульта на 1',
